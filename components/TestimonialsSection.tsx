...
const TestimonialsSection = () => {
  return (
    <section id="stories" className="py-20 sm:py-32 relative">
      ...
      {/* Background Decor */}
      <div className="absolute top-0 right-0 -translate-y-1/2 w-96 h-96 bg-primary/5 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className='flex flex-col items-center'>
          <div className="text-primary font-bold tracking-widest uppercase text-xs border border-primary/20 px-3 py-1 rounded-full bg-background/50 backdrop-blur-sm mb-5">
            Community Stories
          </div>
          <h2 className="text-3xl md:text-4xl font-heading font-bold mb-4 text-foreground">
            Kind Words from <span className="text-primary italic">Our Tribe</span>
          </h2>
          <p className="text-muted text-lg font-sans leading-relaxed mb-16">
            We don't just teach yoga; we build community lore.
          </p>
